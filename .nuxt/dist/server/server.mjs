import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, resolveComponent, mergeProps, withCtx, createTextVNode, useSSRContext, withAsyncContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
import "klona";
import "devalue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
    ...
    async function getIcon() {
      try {
        const iconsImport = /* @__PURE__ */ Object.assign({
          "/assets/icons/basket.svg": () => import("./_nuxt/basket-aQsiZGXp.js").then((m) => m["default"]),
          "/assets/icons/like.svg": () => import("./_nuxt/like-ukxM8O3x.js").then((m) => m["default"]),
          "/assets/icons/ok.svg": () => import("./_nuxt/ok-C-p1CqPj.js").then((m) => m["default"])
        });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BPqzaL9X.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CEDSK05a.js").then((r) => r.default || r));
