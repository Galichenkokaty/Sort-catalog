...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.DAmX8WXb.mjs').then(interopDefault),
  "node_modules/nuxt-icons/dist/runtime/components/nuxt-icon.vue": () => import('./_nuxt/nuxt-icon-styles.CDyZvWRf.mjs').then(interopDefault),
  "node_modules/nuxt-icons/dist/runtime/components/nuxt-icon.vue?vue&type=style&index=0&lang.css": () => import('./_nuxt/nuxt-icon-styles.CDyZvWRf.mjs').then(interopDefault),
  "components/catalog/catalog.vue": () => import('./_nuxt/catalog-styles.DEoEvao7.mjs').then(interopDefault),
  ...
  "components/breadcrums/breadcrums.vue": () => import('./_nuxt/breadcrums-styles.sumpWQC8.mjs').then(interopDefault)
}